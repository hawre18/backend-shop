    ...
    <div class="container-fluid">
        <div class="layout-specing">
            <div class="d-md-flex justify-content-between">
                <h5 class="mb-0">لیست استان ها</h5>
                        ...
                        <table class="table table-center bg-white mb-0">
                            ...
                            <tr>
                                ...
                                <td class="text-start">
                                    ...
                                    <a href="{{route('provinces.edit',$row->id)}}" class="btn btn-icon btn-pills btn-soft-success"><i class="uil uil-pen"></i></a>
                                    <a href="{{route('provinces.delete',$row->id)}}" class="btn btn-icon btn-pills btn-soft-danger"><i class="uil uil-trash"></i></a>
                                </td>
                            </tr>
                                @endforeach
                            </tbody>

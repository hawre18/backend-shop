...
@section('content')
    <div class="layout-specing">
        <div class="d-md-flex justify-content-between">
            <h5 class="mb-0">افزودن سمت جدید</h5>
                        ...
                        <div class="card border-0 p-4 rounded shadow">
                            <form >
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">سطوح دسترسی</label>
                                            <select name="permission" class="form-control select2input">
                                                <option disabled selected>انتخاب کنید</option>
                                                <option value="category-per">دسته بندی ها</option>
                                                <option value="baner-per">بنرها</option>
                                            </select>
                                        </div>
                                    </div><!--end col-->
                                </div><!--end row-->

                                <button type="submit" class="btn btn-primary">افزودن سمت</button>
                            </form>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
